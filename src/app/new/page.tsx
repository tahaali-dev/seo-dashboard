...
export default function NewProject() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-200 font-sans selection:bg-indigo-500/30 flex items-center justify-center p-4">
      <div className="fixed inset-0 z-[-1] bg-[radial-gradient(ellipse_at_top_right,var(--tw-gradient-stops))] from-indigo-900/20 via-slate-900 to-slate-900"></div>
      ...
      <div className="w-full max-w-2xl bg-slate-800/30 border border-slate-700/50 rounded-2xl p-8 backdrop-blur-xl shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
        <a
          href="/"
          className="absolute -top-10 left-0 text-slate-400 hover:text-white text-sm font-medium flex items-center gap-1 transition-colors"
        >
          <svg
            className="w-4 h-4"
            fill="none"
        ...
        <div className="flex items-center gap-3 mb-8">
          <div className="w-10 h-10 rounded-xl bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center font-bold text-white shadow-lg shadow-indigo-500/20">
            SEO
          </div>
          <div>
            ...
            <p className="text-sm text-slate-400">
              Step 1 — Define your audit type and website URLs
            </p>
          </div>
        </div>
        ...
        <form action={createProject} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Audit a single website for SEO issues, broken links, and
                metadata health.
              </p>
            </button>
            <button
            ...
            >
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Compare an old website against a new staging website to prevent
                SEO regression.
              </p>
            </button>
          </div>
          ...
          >
            {auditType === "MIGRATION" && (
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-1">
                  Old Website URL <span className="text-red-400">*</span>
                </label>
                <input
                  type="url"
                  name="oldWebsite"
            ...
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1">
                {auditType === "MIGRATION" ? "New Website URL" : "Website URL"}{" "}
