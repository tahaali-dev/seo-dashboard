    ...
    <div className="min-h-screen bg-slate-900 text-slate-200 p-8 font-sans">
      <div className="max-w-6xl mx-auto space-y-8">
        <header className="flex justify-between items-end border-b border-slate-800 pb-6">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Audited Websites</h1>
            <p className="text-slate-400">View and manage all your SEO audits and migrations.</p>
          </div>
          <div>
            <Link 
              href="/new" 
        ...
        {projects.length === 0 ? (
          <div className="bg-slate-800/30 border border-slate-700 rounded-xl p-12 text-center flex flex-col items-center">
            ...
            <p className="text-slate-400 max-w-md mb-6">You haven't run any SEO audits or migrations yet. Create your first project to get started.</p>
            <Link href="/new" className="bg-slate-700 hover:bg-slate-600 text-white px-6 py-2.5 rounded-lg font-medium transition-colors">
              Create Project
            </Link>
          </div>
        ) : (
              ...
              >
                ...
                <div className="space-y-2 mb-6 flex-1">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-slate-300 truncate max-w-[150px]" title={project.newWebsite}>
                  ...
                  {project.auditType === 'MIGRATION' && project.oldWebsite && (
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-slate-300 truncate max-w-[150px]" title={project.oldWebsite}>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-700/50">
                  <div className="flex items-center gap-4">
                    <div className="flex flex-col">
                      <span className="text-[10px] text-slate-500 uppercase tracking-widest font-semibold">Pages</span>
                      <span className="text-slate-300 font-medium">{project._count.pages}</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-[10px] text-slate-500 uppercase tracking-widest font-semibold">Issues</span>
                      <span className="text-slate-300 font-medium">{project._count.issues}</span>
                    </div>
                  </div>
